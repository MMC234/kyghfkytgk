...
pele1 =createSprite(100,100,100,100)
pele1.addImage(pele)
pele1.scale=0.2
pele1.setCollider("rectangle",0,0,300,300)
pele1.velocityX=20
pele1.velocityY=16
...
pele1.bounceOff(bordas)
if(Bug.isTouching(JogadoresClassicos)){
...
pele1.collide(bordas);
//o jogador volta à imagem original quando pararmos de pressionar a barra de espaço

if(player.isTouching(pele1)){
